<template>
    <div class="bg-mustard text-primary">
        ...
        <div class="container mx-auto md:px-12 mobile:px-10">
            ...
            <section class="relative" data-aos="fade-up" data-aos-offset="200" data-aos-easing="ease-out" data-aos-anchor-placement="center-bottom">
            ...
            <section class="contact mt-64 mobile:mt-32 relative" data-aos="fade-up" data-aos-easing="ease-out" data-aos-offset="800" data-aos-anchor-placement="center-bottom">
            ...
            <section data-aos="flip-up" data-aos-easing="ease-out" data-aos-delay="1000" data-aos-duration="500" data-aos-anchor=".contact" data-aos-offset="200">
                <span class="lg:text-lg sm:text-lg mobile:text-md">👉 </span><a href="mailto:hi@chilinotchilly.com" class="lg:text-lg sm:text-lg mobile:text-md underline">hi@chilinotchilly.com</a>
            </section>
