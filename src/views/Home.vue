<template>
    <div class="bg-mustard text-primary">
        ...
        <div class="container mx-auto md:px-12 mobile:px-10">
            ...
            <section class="relative" data-aos="fade-up" data-aos-offset="400" data-aos-easing="ease-out">
            ...
            <section id="contact" class="mt-64 mobile:mt-32 relative" data-aos="fade-up" data-aos-easing="ease-out" data-aos-delay="300" data-aos-anchor-placement="top-center">
            ...
            <section data-aos="flip-up" data-aos-easing="ease-out" data-aos-delay="1000" data-aos-anchor-placement="top-center">
            ...
            <img src="../assets/img/chili-team.png" class="mt-40 mobile:mt-12" alt="Chili team" data-aos="fade-up" data-aos-easing="ease-out" data-aos-duration="1000" data-aos-anchor-placement="top-center">
        </div>
    </div>
</template>
